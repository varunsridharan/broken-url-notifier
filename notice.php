...
$bun_plug_url = plugins_url('',__FILE__).'/';
...
<style> img{ margin-right:10px; vertical-align: middle;cursor: pointer;} img.addBorder{border:3px solid #595959;} </style>
        ...
        <tbody> 
            ...
            <tr valign="top">
                ...
                <td class="forminp forminp-select">
                    <img src="<?php echo $bun_plug_url; ?>img1.jpg" width="50px" />
                    <img src="<?php echo $bun_plug_url; ?>img2.jpg" width="50px" />                    
                    <input id="upload_image_button" class="button" type="button" value="Upload or Choose Image"  style="    vertical-align: middle;"/>
            ...
            <tr valign="top">
                ...
                <td class="forminp forminp-select">
                    <input id="notic_email_subject" type="text" size="36" name="notic_email_subject" value="<?php echo @get_option('broken_url_notifier_email_subject'); ?>" />
                </td>
            </tr>
            <tr valign="top">
                ...
                <td class="forminp forminp-select">
                    <input id="notic_email" type="text" size="36" name="notic_email" value="<?php echo @get_option('broken_url_notifier_email'); ?>" />
                </td>
            </tr>
        </tbody>
    </table>
...
function add_this_script_footer(){ 
  echo "  <script>jQuery(document).ready(function(){
	jQuery('img').error(function() {
        ...
        jQuery(this).attr('src', '".get_option('broken_url_notifier_img')."');	
